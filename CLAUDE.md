...
| 2026-08-18 | LinkedIn content + client channel | Sobrynth article "Guidance Instead of Guesswork" — published, then native posts from **both** her personal profile (cover B) and the Sobrynth page (cover A), running concurrently. Time of day TBD. | _Pending — log at 24h, separately for each post: impressions, comments, reposts, and profile views/search appearances for the week._ **Watch the split-velocity question**: audiences overlap, so two simultaneous near-duplicate posts should underperform one. If the personal post lands near the 2,267-impression benchmark and the page post trails badly, that confirms it — stagger 60–90 min next time. If both do well, the overlap matters less than assumed and the rule can relax. |
